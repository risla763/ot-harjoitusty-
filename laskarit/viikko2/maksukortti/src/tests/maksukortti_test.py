...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_edullisesti_ei_vie_saldoa_negatiiviseksi(self):
        kortti = Maksukortti(200)
        kortti.syo_maukkaasti()

        self.assertEqual(kortti.saldo_euroina(), 2.0) #tarkista toimiiko
    ...
    def test_syo_edullisesti_ja_rahaa_on_minimi(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_syo_maukkaasti_ja_rahaa_on_minimi(self):
